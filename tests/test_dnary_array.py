import numpy as np
from qclif._qclifBase.dnary_array import PrimeDnaryArrayBase


class D5(PrimeDnaryArrayBase):d=5
class D3(PrimeDnaryArrayBase):d=3
...
def test_random_inverse():
    for _ in range(10):
        t=D3.random_matrix((12,12))
        s=D5.random_matrix((16,16))
